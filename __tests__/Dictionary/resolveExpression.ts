...
describe("resolveExpression", () => {
  ...
  it("resolves an expression with a single parameter", async () => {
    ...
    const resolved = await dictionary.resolveExpression({ language: "en-US", expression });
  ...
  it("resolves an expression with a dollar sign on the value string", async () => {
    ...
    const resolved = await dictionary.resolveExpression({ language: "pt-BR", expression });
