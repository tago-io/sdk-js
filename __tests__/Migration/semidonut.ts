import { convert, isOldStructure } from "../../src/modules/Migration/semidonut.ts";
import * as oldStructure from "./__mocks__/widgetsOldStructure.json";

const oldWidget = oldStructure.semidonutStructure;

describe("Semidonut widget - migration suite", () => {
  /**
  ...
  it("converts base structure properly", () => {
    ...
    expect(newStructure.type).toEqual("semidonut");
  });
