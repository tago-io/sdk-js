import { convert, isOldStructure } from "../../src/modules/Migration/display.ts";
import * as oldStructure from "./__mocks__/widgetsOldStructure.json";

const oldWidget = oldStructure.displayStructure;

describe("Display widget - migration suite", () => {
  /**
  ...
  it("converts base structure properly", () => {
    ...
    expect(newStructure.type).toEqual("display");
  });
