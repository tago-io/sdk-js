import { convert, isOldStructure } from "../../src/modules/Migration/multipleaxischart.ts";
import * as oldStructure from "./__mocks__/widgetsOldStructure.json";

const oldWidget = oldStructure.multipleaxischartStructure;

describe("Multiple axis chart widget - migration suite", () => {
  /**
  ...
  it("converts base structure properly", () => {
    ...
    expect(newStructure.type).toEqual("multiple_axis_chart");
  });
  ...
  /**
   * Check if correctly applies max points, stacked and line curve are correct
   */
  it("correctly insert max points, stacked and line curve", () => {
