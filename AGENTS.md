...
npm run monacoTypes    # Generate Monaco editor types
```
...
// Incorrect - missing types (will cause build errors)
...
- `eventsource`: Server-sent events (for streaming features)
...
- [TagoIO SDK Documentation](https://js.sdk.tago.io/)
