...
declare class Devices extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	list<T extends DeviceQuery>(queryObj?: T): Promise<DeviceListItem<T["fields"] extends ("type" | "id" | "active" | "network" | "name" | "visible" | "description" | "updated_at" | "profile" | "connector" | "created_at" | "bucket" | "tags" | "last_input" | "payload_decoder" | "rpm")[] ? T["fields"][number] : "id" | "name">[]>;
	/**
	 ...
	 * ```
	 */
	listStreaming(queryObj?: Omit<DeviceQuery, "page" | "amount">, options?: OptionsStreaming): AsyncGenerator<DeviceListItem<"type" | "id" | "active" | "network" | "name" | "visible" | "description" | "updated_at" | "profile" | "connector" | "created_at" | "bucket" | "tags" | "last_input" | "payload_decoder" | "rpm">[], void, unknown>;
	/**
	 ...
	 * ```
	 */
	tokenList<T extends ListDeviceTokenQuery>(deviceID: GenericID, queryObj?: T): Promise<DeviceTokenDataList<T["fields"] extends (keyof DeviceTokenData)[] ? T["fields"][number] : "name" | "token" | "permission">[]>;
	/**
...
declare class Widgets extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	deleteData(dashboardID: GenericID, widgetID: GenericID, variableID: GenericID, deviceID: GenericID): Promise<string>;
	/**
...
declare class Profile extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	tokenCreate(profileID: GenericID, tokenParams: TokenData & Authenticator): Promise<TokenCreateResponse>;
	/**
...
declare class ServiceAuthorization extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	tokenCreate(tokenParams: TokenData): Promise<TokenCreateResponse$1>;
	/**
	 ...
	 * ```
	 */
	tokenEdit(token: GenericToken$1, verificationCode?: string): Promise<string>;
}
...
declare class Account extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	static confirmAccount(token: GenericToken, region?: Regions | RegionsObj): Promise<string>;
	/**
...
export declare class RunUser extends TagoIOModule<GenericModuleParams> {
	 ...
	 * @param region TagoIO Region Server [default usa-1]
	 */
	static confirmUser(tagoIORunURL: string, token: GenericToken, region?: Regions | RegionsObj): Promise<string>;
	/**
