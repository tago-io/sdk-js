...
declare class TagoCores extends TagoIOModule<GenericModuleParams> {
	 ...
	 * @param queryObj Search query params
	 */
	clusterDeviceList<T extends DeviceQuery>(clusterID: GenericID, queryObj?: T): Promise<DeviceListItem<"id" | "name" | T["fields"][number]>[]>;
}
...
export type OpenSSEWithID = GenericModuleParams & {
	channel: ChannelWithID;
	resource_id: string;
};
export type OpenSSEWithoutID = GenericModuleParams & {
	channel: ChannelWithoutID;
};
export type OpenSSEConfig = OpenSSEWithID | OpenSSEWithoutID;
declare function openSSEListening(params: OpenSSEConfig): Promise<EventSource>;
