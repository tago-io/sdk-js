...
declare class Analyses extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	list<T extends AnalysisQuery>(queryObj?: T): Promise<AnalysisListItem<T["fields"] extends (keyof AnalysisInfo)[] ? T["fields"][number] : "name" | "id">[]>;
	/**
...
declare class Devices extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	list<T extends DeviceQuery>(queryObj?: T): Promise<DeviceListItem<T["fields"] extends ("updated_at" | "profile" | "connector" | "network" | "name" | "active" | "created_at" | "bucket" | "id" | "description" | "tags" | "visible" | "last_input" | "type" | "payload_decoder" | "rpm")[] ? T["fields"][number] : "name" | "id">[]>;
	/**
	 ...
	 * ```
	 */
	listStreaming(queryObj?: Omit<DeviceQuery, "page" | "amount">, options?: OptionsStreaming): AsyncGenerator<DeviceListItem<"updated_at" | "profile" | "connector" | "network" | "name" | "active" | "created_at" | "bucket" | "id" | "description" | "tags" | "visible" | "last_input" | "type" | "payload_decoder" | "rpm">[], void, unknown>;
	/**
...
declare class Files extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	uploadFile(file: Blob | Buffer, filename: string, options?: UploadOptions): Promise<{
		file: string;
	}>;
	/**
...
declare class Run extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	listUsers<T extends UserQuery>(query: T): Promise<UserListItem<T["fields"] extends (keyof UserInfo)[] ? T["fields"][number] : "name" | "id">[]>;
	/**
...
declare class TagoCores extends TagoIOModule<GenericModuleParams> {
	 ...
	 * ```
	 */
	standaloneDeviceList<T extends DeviceQuery>(tagoCoreID: GenericID, queryObj?: T): Promise<DeviceListItem<"name" | "id" | T["fields"][number]>[]>;
}
