 ...
 */
export type SnippetRuntime = "node-legacy" | "python-legacy" | "node-rt2025" | "python-rt2025" | "deno-rt2025";
/**
 ...
 */
export type DataStorageType = "immutable" | "mutable" | "legacy" | "hybrid";
...
export type BucketInfoHybrid = Omit<BucketInfoBasic, "data_retention" | "data_retention_ignore"> & {
	type: "hybrid";
	/**
	 * Chunk division to retain data in the device.
	 *
...
export type BucketInfo = BucketInfoImmutable | BucketInfoMutable | BucketInfoLegacy | BucketInfoHybrid;
...
export interface WidgetData {
	...
	variables?: string[];
	bucket?: GenericID;
	query?: "min" | "max" | "count" | "avg" | "sum" | "last_value" | "last_item" | "last_insert" | "aggregate" | "conditional";
	start_date?: Date | string;
	end_date?: Date | string;
	overwrite?: boolean;
}
 ...
 */
export interface DeviceCreateInfoHybrid extends Omit<DeviceCreateInfoBasic, "type"> {
	type: "hybrid";
	/**
	 * Chunk division to retain data in the device.
	 *
...
export type DeviceCreateInfo = DeviceCreateInfoLegacy | DeviceCreateInfoMutable | DeviceCreateInfoImmutable | DeviceCreateInfoHybrid;
...
export interface DeviceEmptyParams {
	/**
...
export type DeviceInfoHybrid = Required<DeviceInfoBase & Omit<DeviceCreateInfoHybrid, "configuration_params" | "serie_number" | "connector_parse" | "parse_function">>;
export type DeviceInfo = DeviceInfoImmutable | DeviceInfoMutable | DeviceInfoHybrid;
...
export interface SQLCreateInfo {
	/** Required, 1..=64 chars. */
	name: string;
...
export interface SQLInfo extends SQLCreateInfo {
	id: GenericID;
	version: number;
	created_at: Date;
	updated_at: Date;
...
export type SQLListField = "id" | "name" | "tags" | "active" | "created_at" | "updated_at";
export type SQLQuery = Omit<Query<SQLInfo, "name" | "active" | "created_at" | "updated_at">, "fields"> & {
	fields?: SQLListField[];
};
export interface SQLExecuteObj {
...
export interface SQLResourceItem {
	id: GenericID;
	name: string;
}
...
export interface SQLTablesQuery {
...
export interface TagoTiPCommand {
 ...
 * ```
 */
export declare class TagoTiP extends TagoIOModule<GenericModuleParams> {
	/**
	 * Send a command to a device through TagoTiP.
	 *
	 * @param command Command object with serial, protocol and body
	 */
	cmd(command: TagoTiPCommand): Promise<string>;
}
/**
...
export type RunTypeOptions = "node-legacy" | "python-legacy" | "node-rt2025" | "python-rt2025" | "deno-rt2025" | "other";
...
declare class SQL extends TagoIOModule<GenericModuleParams> {
	/**
	 ...
	 * ```
	 */
	list(queryObj?: SQLQuery): Promise<SQLInfo[]>;
	/**
	 ...
	 * ```
	 */
	create(sqlObj: SQLCreateInfo): Promise<SQLInfo>;
	/**
	 ...
	 * ```
	 */
	info(sqlID: GenericID): Promise<SQLInfo>;
	/**
	 ...
	 * ```
	 */
	edit(sqlID: GenericID, sqlObj: SQLCreateInfo): Promise<SQLInfo>;
	/**
	 ...
	 * ```
	 */
	delete(sqlID: GenericID): Promise<{
		id: GenericID;
	}>;
	/**
	 ...
	 * ```
	 */
	getVersion(sqlID: GenericID, version: number): Promise<SQLVersionInfo>;
	/**
	 ...
	 * ```
	 */
	execute(sqlID: GenericID, executeObj?: SQLExecuteObj): Promise<SQLExecuteResult>;
	/**
	 ...
	 * ```
	 */
	tables(queryObj?: SQLTablesQuery): Promise<SQLTablesResult>;
}
/**
